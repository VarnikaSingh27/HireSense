...
import { saveResumeUrl } from "@/src/lib/actions/rank/rankResumes";
        ...
        >
          {!uploadComplete ? (
                ...
                <UploadDropzone
                  ...
                  onClientUploadComplete={async (res) => {
                    ...
                    try {
                      ...
                      await saveResumeUrl(email, url);
                    } catch (error) {
                      console.error("Error sending PDF URL to backend or saving in DB:", error);
                    }
                  }}
            ...
            <>
              ...
              <Link
                href="/u/dashboard"
                className="mt-4 w-full inline-block text-center py-3 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-all duration-300 shadow-md"
              >
