    ...
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900 text-center p-6">
      <div className="bg-red-100 dark:bg-red-800 p-8 rounded-xl shadow-xl max-w-xl">
        ...
        <p className="text-gray-800 dark:text-gray-200 mb-6">
          {email || "This email"} is not a valid official email. Employers must sign up with
...
export default function UnauthorizedPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900">Loading...</div>}>
      <UnauthorizedContent />
    </Suspense>
  );
}
