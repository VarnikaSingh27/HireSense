    ...
    <div className="min-h-[80vh] flex flex-col p-4 lg:p-6 my-8">
      ...
      <section className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md border border-green-100 dark:border-green-900/20 hover:shadow-lg transition-shadow">
          ...
          <p className="mb-2 text-gray-600 dark:text-gray-400">
            <span className="font-medium text-gray-800 dark:text-gray-300">General:</span> support@hiresense.com
          </p>
          <p className="mb-2 text-gray-600 dark:text-gray-400">
            <span className="font-medium text-gray-800 dark:text-gray-300">Technical:</span> tech@hiresense.com
          </p>
          <p className="mb-2 text-gray-600 dark:text-gray-400">
            <span className="font-medium text-gray-800 dark:text-gray-300">Feedback:</span> feedback@hiresense.com
          </p>
        </div>
