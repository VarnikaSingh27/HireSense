          ...
          <div className="relative flex-shrink-0">
            {!imageError && profilePic ? (
              <Image
                ...
                width={40}
                height={40}
                className="rounded-full ring-2 ring-purple-200 dark:ring-purple-900 object-cover"
                onError={() => setImageError(true)}
              />
            ) : (
              <div className="w-10 h-10 rounded-full ring-2 ring-purple-200 dark:ring-purple-900 bg-gradient-to-tr from-purple-500 to-indigo-500 flex items-center justify-center text-white font-bold text-sm uppercase shadow-sm">
                {givenName ? givenName[0] : (email ? email[0] : "U")}
              </div>
            )}
